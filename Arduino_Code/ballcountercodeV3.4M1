...
//
// Calibration basis:
// - Old machine with new mounting
// - Uses ONLY the latest dataset provided for this machine/mount
// - Smooth cubic fit, no piecewise breakpoints
// - Removes the jump around the middle of the previous graph
//

// ============================================================

float calibrateSpeed(float rawMph) {
  return -0.00007456 * rawMph * rawMph * rawMph
         + 0.00855664 * rawMph * rawMph
         + 0.62020785 * rawMph
         + 6.11230051;
}
